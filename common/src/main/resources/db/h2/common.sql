...
CREATE TABLE PARTNER_MERCHANT_STATE(
    ID VARCHAR(20) NOT NULL
  , DESCRIPTION VARCHAR(512)
  , PRIMARY KEY (ID)
);

INSERT INTO PARTNER_MERCHANT_STATE (ID) VALUES ('WAITED_FOR_PARENT');
INSERT INTO PARTNER_MERCHANT_STATE (ID) VALUES ('WAITED_FOR_MERCHANT');
INSERT INTO PARTNER_MERCHANT_STATE (ID) VALUES ('CONFIRMED');
...
CREATE TABLE PARTNER_MERCHANT (
    ...
    , USE_MERCHANT_BALANCE INT DEFAULT 0
    , PRIMARY KEY (ID)
    , CONSTRAINT FK_PARTNER_MERCHANT_1 FOREIGN KEY (PARENT) REFERENCES PARTNER(ID) ON DELETE CASCADE
    , CONSTRAINT FK_PARTNER_MERCHANT_2 FOREIGN KEY (PARTNER) REFERENCES PARTNER(ID) ON DELETE CASCADE
    , CONSTRAINT FK_PARTNER_MERCHANT_3 FOREIGN KEY (STATE_ID) REFERENCES PARTNER_MERCHANT_STATE(ID) ON DELETE SET NULL
);
